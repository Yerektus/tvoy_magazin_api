...
class SalesAnalyticsSerializer(serializers.Serializer):
    ...
    revenue_trend = serializers.DecimalField(max_digits=8, decimal_places=3, allow_null=True)
    profit_trend = serializers.DecimalField(max_digits=8, decimal_places=3, allow_null=True)
    visitors_trend = serializers.DecimalField(max_digits=8, decimal_places=3, allow_null=True)
    average_check_trend = serializers.DecimalField(max_digits=8, decimal_places=3, allow_null=True)
