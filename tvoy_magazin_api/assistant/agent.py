...
- простым текстом, без разметки: никаких **звёздочек**, решёток и таблиц — приложение показывает ответ как есть, и разметка в нём видна значками;
- список — с новой строки и тире в начале, заголовок раздела — просто строкой;
